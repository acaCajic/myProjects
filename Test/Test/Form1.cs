...
namespace Test
{
    public partial class Form1 : Form
    {
        ...
        private void ugasiMenu()
        {
            ...
            saveToolStripMenuItem.Visible = false;
            saveToolStripMenuItem.Enabled = false;
            loadToolStripMenuItem1.Visible = false;
            ...
            else if (me.Button == MouseButtons.Left)
            {
                ...
                else
                {
                    ...
                    if (da_li_ima == false)
                    {
                        ...
                        noviCvor.zaCrtanje = brojacZaCrtanje++;
        ...
        private void snimiPodatke(Prenos pr)
        {
            ...
            brsema++;
            pomZaEDIT = 0;
            MessageBox.Show("Usnimljeno je u bazu podataka");
        }
        ...
        private void loadToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            sema = new Sema();
            osveziListBoxove();
            Load l = new Load(korisnicki_nalog,sema, k);
        ...
        private void doodlerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (Bitmap bmp = new Bitmap(pictureBox1.Width, pictureBox1.Height))
            {
                pictureBox1.DrawToBitmap(bmp, new Rectangle(0, 0, bmp.Width, bmp.Height));
                pictureBox1.Image = new Bitmap(pictureBox1.Width, pictureBox1.Height);
                Image img = (Image)(new Bitmap((Image)bmp, new Size(701, 353)));
        ...
        {
            RadoviForma rf =new RadoviForma(this.k,this.sema,korisnicki_nalog);
            rf.ShowDialog();
            int maxid = 0;
            foreach (Cvor k3 in sema.cvorovi)
            {
        ...
        private void saveToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            sf.StartPosition = FormStartPosition.Manual;
            sf.Location = this.Location;
            //sf.Left += this.ClientSize.Width / 2 - sf.Width / 2;
            // sf.Top += this.ClientSize.Height / 2 - sf.Height / 2;
            sf.ShowDialog();
            //Debugger.Break();
            if (p.godina != -1)
                snimiPodatke(p);
